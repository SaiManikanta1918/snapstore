      ...
      <Flex gap={{ base: 4, sm: 10 }} direction={{ base: 'column', sm: 'row' }}>
        ...
        <VStack alignItems={{ base: 'center', md: 'start' }} gap={2} mx={'auto'} flex={1}>
          <Flex
            ...
            w={'full'}
          >
            <Text fontSize={{ base: '2xl', md: '5xl' }}>{userProfile.fullName}</Text>
            <Text fontSize={'xl'} fontWeight={'bold'} textColor={'whiteAlpha.600'}>
              @{userProfile.username}
            </Text>
          </Flex>
          <Flex alignItems={'center'} gap={{ base: 2, sm: 4 }}>
            <Text p={2} borderRadius={6} fontSize={{ base: 'xs', md: 'sm' }} cursor="pointer">
